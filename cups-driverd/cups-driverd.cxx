        ...
        int        request_id)		/* I - Request ID for response? */
{
  ...
  char finaloc1[1024],finaloc2[1024];
  snprintf(finaloc1,sizeof(finaloc1),"%s/usr/share/cups/ppdc/",snap);
  src = new ppdcSource(NULL,NULL);
  src->add_include(finaloc1);

  src->read_file(filename, fp);
